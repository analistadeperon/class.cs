...
class Program
{
    static void Main(string[] args)
    {
        ...
        _agendaTelefonicaList.Add(new Agenda("Jonh", "Rua Candido", "8989-8989"));
        _agendaTelefonicaList.Add(new Agenda("JAva", "Rua Heli Costa", "1111-5245"));
        _agendaTelefonicaList.Add(new Agenda("Ruby", "Rua Otavio", "6565-878"));
